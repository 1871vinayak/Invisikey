...
namespace Helper {
	...
	struct DateTime
	{
		...
		std::string GetTimeString() const; // Member function to get the time as a string 
		std::string GetDateTimeString() const; // Member function to get the date and time as a string
	};
